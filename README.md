...
### Installation
First, install ALL of the libraries. Some more are here for the work in progress SatchelTwo GUI application (Go check the discussions!) Just go to the most recent release and download the zip. I'd reccomend putting the files in a folder named "SatchelTwo" in your documents folder, as this is where most files for the project will be stored. =

### Running it
Open up CMD or Terminal or any command line of your choice that Python can be executed from and run:
- **Windows: python init.py**
- **Linux / MacOS: python3 ./init.py**
It varies per os because how am I supposed to know, ask the Python Project!
