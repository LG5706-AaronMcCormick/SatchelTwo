...
### CURRENT STAGE: Milestone 1.1
### Working on Student Token implementation.
...
### Installation
Just go to the most recent release and download the zip. I'd reccomend putting the files in a folder named "SatchelTwo" in your documents folder, as this is where most files for the project will be stored.
